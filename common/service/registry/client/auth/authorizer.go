...
import (
	...
	commonhttp "github.com/donknap/dpanel/common/service/registry/http"
	"github.com/donknap/dpanel/common/service/registry/types"

	"github.com/docker/distribution/registry/client/auth/challenge"

	"github.com/donknap/dpanel/common/service/registry/client/auth/basic"
	"github.com/donknap/dpanel/common/service/registry/client/auth/bearer"
	"github.com/donknap/dpanel/common/service/registry/client/auth/null"
)

// NewAuthorizer creates an authorizer that can handle different auth schemes
func NewAuthorizer(username, password string, insecure bool) types.Authorizer {
	return &authorizer{
		username: username,
		password: password,
		client: &http.Client{
...
type authorizer struct {
	...
	authorizer types.Modifier // the underlying authorizer
}
