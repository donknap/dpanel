...
amd64:
	...
	go build ${COMMON_PARAMS} -o ${GO_TARGET_DIR}/${PROJECT_NAME}-amd64-musl ${GO_SOURCE_DIR}/*.go
...
arm64:
	...
	go build ${COMMON_PARAMS} -o ${GO_TARGET_DIR}/${PROJECT_NAME}-arm64-musl ${GO_SOURCE_DIR}/*.go
	cp ${GO_SOURCE_DIR}/config.yaml ${GO_TARGET_DIR}/config.yaml
armv7:
	...
	go build ${COMMON_PARAMS} -o ${GO_TARGET_DIR}/${PROJECT_NAME}-arm-musl ${GO_SOURCE_DIR}/*.go
	cp ${GO_SOURCE_DIR}/config.yaml ${GO_TARGET_DIR}/config.yaml
build:
