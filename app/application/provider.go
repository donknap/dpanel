...
func (provider *Provider) Register(httpServer *httpserver.Server) {
	...
	httpServer.RegisterRouters(
		func(engine *gin.Engine) {
			...
			cors.POST("/app/container-upgrade/get-list", controller.ContainerUpgrade{}.GetList)
			cors.POST("/app/container-upgrade/check", controller.ContainerUpgrade{}.Check)
			cors.POST("/app/container-upgrade/upgrade", controller.ContainerUpgrade{}.Upgrade)
			cors.POST("/app/container-upgrade/ignore", controller.ContainerUpgrade{}.Ignore)
