...
require (
	...
	github.com/we7coreteam/w7-rangine-go/v2 v2.0.1
...
require (
	...
	github.com/compose-spec/compose-go/v2 v2.3.0 // indirect
	...
	github.com/we7coreteam/gorm-gen-yaml v1.0.8 // indirect
